...
export const CASES = [
  {
    ...
    no: '01',
    client: 'Wheels Up',
    sector: 'Aviation Tech · USA',
    title: 'Bringing 50+ analytics dashboards into one design system',
    year: '2024 - Present',
    ...
    variant: 'dash',
    summary:
      'I partnered with the VP of Business Intelligence to redesign internal reporting across operations, sales and finance. That meant auditing a sprawl of inconsistent dashboards and building a scalable Figma design system behind them.',
    meta: [
      ['Role', 'Senior UX Designer, design systems, data viz'],
      ['Scope', 'Research, IA, component library, 50+ dashboards'],
      ['Year', '2024 to present'],
    ],
    stats: [
      { n: 50, suffix: '+', label: 'dashboards consolidated' },
      { n: 25, suffix: '%', label: 'faster report generation' },
      { n: 3, suffix: '', label: 'teams on one system: ops, sales, finance' },
    ],
    tags: ['Enterprise', 'Data Visualisation', 'Design Systems', 'B2B'],

    intro:
      'Wheels Up is a global on-demand private aviation company. Their teams run on data, but that data lived in more than 50 dashboards that had each grown on their own. I worked directly with the VP of Business Intelligence and Data Analytics to bring it all back into focus.',
    context: [
      ['Company', 'Wheels Up, private aviation (USA)'],
      ['My role', 'Senior UX Designer (Exult Global)'],
      ['Partnered with', 'VP, Business Intelligence & Analytics'],
      ['Platform', 'Internal web, Figma'],
      ['Timeline', '2024 to present'],
    ],
    challenge:
      'Fifty plus dashboards across operations, sales and finance had each been built by different people at different times. The same chart meant different things on different screens, KPIs were framed inconsistently, and pulling a report was slow. Leadership was making fast decisions on data that was hard to read.',
    approach: [
      { title: 'Audit and stakeholder research', body: 'I inventoried every dashboard and sat with operations, sales and finance to learn how data actually gets read and acted on day to day.' },
      { title: 'Patterns and information architecture', body: 'I pulled out the chart, table and filter patterns that repeated across dashboards, then set a consistent hierarchy and a shared way of framing KPIs.' },
      { title: 'A scalable design system', body: 'I built a Figma component library, covering cards, charts, tables, filters and empty states, so any new dashboard could be assembled from one consistent kit.' },
      { title: 'Consolidate and hand off', body: 'I merged overlapping dashboards, standardised the data-viz language, and worked closely with engineers to ship the system into production.' },
    ],
    outcomes: [
      { n: 50, suffix: '+', label: 'dashboards consolidated into one system' },
      { n: 25, suffix: '%', label: 'faster report generation' },
      { text: 'One shared design language now used across operations, sales and finance.' },
    ],
    gallery: [],
    learning:
